...
Rails.application.config.sorcery.configure do |config|
  ...
  #
   config.twitter.key = "i22CHjtHfzLQhvSMHkmNw"
   config.twitter.secret = "zNSoBuFHoyBtczDoK1eCNg02AwoZXLFQOTChMWoo"
   config.twitter.callback_url = "http://localhost:3000/oauth/callback?provider=twitter"
   config.twitter.user_info_mapping = {:email => "screen_name"}

   config.facebook.key = "119462718196705"
   config.facebook.secret = "c55bda94519c3b2ee45899f28f830983"
   config.facebook.callback_url = "http://198.101.198.203:3000/oauth/callback?provider=facebook"
